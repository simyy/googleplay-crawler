...
class GooglePlayAPI(object):
    ...
    def executeRequestApi2(self, path, datapost=None, cookies=None, post_content_type="application/x-www-form-urlencoded; charset=UTF-8"):
    ...
    def details(self, packageName):
        ...
        path = "details?doc=%s" % urllib.quote(packageName.encode('utf8'))
        message = self.executeRequestApi2(path)
        if message == False:
           return False 
